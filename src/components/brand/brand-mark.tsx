...
const brandMarkVariants = /* @__PURE__ */ cva("inline-block shrink-0 align-middle", {
  variants: {
    variant: {
 ...
 */
export const BrandMark = /* @__PURE__ */ named(
  /* @__PURE__ */ React.forwardRef<SVGSVGElement, BrandMarkProps>(
    (
 ...
 */
export const BrandWordmark = /* @__PURE__ */ named(
  /* @__PURE__ */ React.forwardRef<HTMLSpanElement, BrandWordmarkProps>(
 ...
 */
export const BrandLockup = /* @__PURE__ */ named(
  /* @__PURE__ */ React.forwardRef<HTMLDivElement, BrandLockupProps>(
    (
      {
        tagline = "",
        size = 40,
      ...
      return (
        <div
          ...
          {...props}
        >
          <BrandMark size={size} {...markProps} />
          <div className={cn("flex flex-col leading-none", stacked && "items-center")}>
            <BrandWordmark size={wordmarkSize} {...wordmarkProps} />
            {showTagline ? (
              <span
